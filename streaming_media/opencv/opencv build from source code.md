...
``` bash
wget https://www.ffmpeg.org/releases/ffmpeg-ffmpeg-7.0.1.tar.gz #https://www.ffmpeg.org/releases/ffmpeg-6.0.1.tar.gz
...
<!-- check install hardware decode and encode -->

```
ffmpeg -hwaccels
```

<!-- check ffmpeg hardware decode -->

```
ffmpeg -hwaccel cuda -i input_file -c:v h264_nvenc -pix_fmt yuv420p -preset p4 -tune hq -b:v 12M -y output.mp4
```
